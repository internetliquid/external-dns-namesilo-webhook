// Command webhook is the ExternalDNS Namesilo webhook provider. It runs two
...
import (
	...
	"github.com/internetliquid/external-dns-namesilo-webhook/internal/config"
	"github.com/internetliquid/external-dns-namesilo-webhook/internal/metrics"
	"github.com/internetliquid/external-dns-namesilo-webhook/internal/namesilo"
	nsprovider "github.com/internetliquid/external-dns-namesilo-webhook/internal/provider"
)
...
const (
	...
	// over a large changeset is applied one throttled Namesilo call at a time
...
func run() error {
	...
	logger.Info("starting external-dns-namesilo-webhook",
		"version", version,
		"dryRun", cfg.DryRun,
